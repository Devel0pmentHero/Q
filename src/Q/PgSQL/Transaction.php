...
/**
 * Class MariaDB represents a SQL-transaction usually created by invoking @see \Q::Transact().
 *
 * @package Q
...
final class Transaction implements ITransaction {
     ...
     *
     * @param mixed       $Provider  Initializes the Transaction with the specified reference of the Provider to use.
     ...
     * @param null|string $Name      The name of the SQL-statement.
     *
     * @return \Q\PgSQL\Transaction The current instance for further chaining.
     */
     ...
     *
     * @return \Q\IResult The result-set yielding any values retrieved from the previous executed statement.
     */
